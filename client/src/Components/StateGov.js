...
const StateGov = () => {
  ...
  <div className="walletAddress"><h3>Connect State Governement Wallet</h3></div>
      ...
      <div className="accountDisplay">
        <h3>Address of State Government's Wallet : {defaultAccount}</h3>
      </div>
      <div className="balanceDisplay">
        <h3>Balance of State Government's Wallet : {userBalance} ETH</h3>
      </div>
      <div className="allocateFunds">
        <h4>{"Allocate Funds for Disrict Government"}</h4>
        <input
          type="text"
      ...
      <div className="transferFunds">
        <h4>{"Transfer Funds to Disrict Government"}</h4>
        <input
          type="text"
          placeholder="To Address"
          value={toAddress}
