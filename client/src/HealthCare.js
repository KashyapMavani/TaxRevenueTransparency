...
const HealthCareSectorPage = () => {
  const [districtGovernmentMoney, setDistrictGovernmentMoney] = useState(1500000); // Replace with the actual received money from district government
